...
public class DepartmentControllerTest {
    ...
    @BeforeEach
    void setup() {
        Employee employee = new Employee(50, "Roy", "roy@gmail.com", "roy123", null);
    ...
    void testCreateDepartmentWithEmployees() {
        when(service.createDepartmentWithEmployees(100L, "sales", dto.getEmployees())).thenReturn(department);
