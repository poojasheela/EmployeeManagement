...
public class EmployeeTest {
    ...
    void testAllArgsConstructor() {
        ...
        Employee emp = new Employee(50, "Roy", "roy@gmail.com", dept);
    ...
    void testEqualsAndHashCode() {
        ...
        Employee e1 = new Employee(1, "Sam", "sam@mail.com",  dept);
        Employee e2 = new Employee(1, "Sam", "sam@mail.com", dept);
    ...
    void testToStringContainsEmail() {
        Employee emp = new Employee(2, "Ann", "ann@mail.com",  null);
