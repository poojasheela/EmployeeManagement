...
public class EmployeeMapperTest {
    ...
    void testToDTO() {
        ...
        Employee employee = new Employee(50, "Roy", "roy@gmail.com",department);
    ...
    @Test
    void testToDTOList() {
        Employee emp1 = new Employee(50, "Roy", "roy@gmail.com", new Department(100L, "Sales"));
        Employee emp2 = new Employee(51, "John", "john@gmail.com",  new Department(101L, "HR"));
